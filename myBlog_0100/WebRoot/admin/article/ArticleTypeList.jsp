                ...
                <td align="center" valign="top">
                	<table width="560" border="0" cellspacing="0" cellpadding="0" rules="none">
						...
						<tr height="35">
							...
							<td align="center"><a href="ArticleAction?action=typeModify&typeId=<%=single.getArticleType_id() %>" class="word_purple ">√修改</a></td>
							<td align="center"><a href="ArticleAction?action=typeDelete&typeId=<%=single.getArticleType_id() %>" class="word_purple ">×删除</a></td>							
						</tr>
						<%
    							}
							}
