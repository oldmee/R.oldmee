			...
			<table width="778" height="600" border="0" cellspacing="0"
				...
				<tr>
					...
					<td width="548" align="center" valign="top">
						<table width="100%" height="55" border="0" cellsapcing="0"
							cellpadding="0" background="<%=basePath%>images/main_B.jpg">
                        	...
                        	%>
								<td>
									<a
										href="ArticleAction?action=select&pageNo=0&typeId=<%=single.getArticleType_id() %>"><%=single.getTypeName() %></a>
								</td>
								<%
                        			}
                        		}
